	...
	<div class="contact-header">
		<div class="container">
			<div class="col-lg-12 col-md-6">
				<h2>Unlock Your Financial Potential with US</h2>
			</div>
			<div class="col-lg-12	 col-md-6">
				<div class="desc">
					<p>Discover how Stirling can guide you towards financial success, whether you're a business or an individual. 
						<br>Get in touch now to start your journey to financial prosperity with our expert team.</p>
				</div>
			</div>
		</div>
	</div>
...
<script>
  document.getElementById('contactForm').addEventListener('submit', function(event) {
    ...
    const phoneRegex = /^(^\+62\s?|^62\s?|^0)(\d{3,4}-?){2}\d{3,4}$/;

    if (!phoneRegex.test(phone) && phone !== '') {
      alert('Invalid phone number. Please enter a valid Indonesian phone number in the format +62 xxx-xxx-xxxx or 0xxx-xxx-xxxx.');
      return;
    }
